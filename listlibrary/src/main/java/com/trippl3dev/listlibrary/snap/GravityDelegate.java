package com.trippl3dev.listlibrary.snap;
...
//                offset +=(((GridLayoutManager) layoutManager).getSpanCount() - 1) ;
            ...
            if (visibleWidth > 0.5f && !endOfList) {
                return child;
                 ...
                 child = layoutManager.findViewByPosition(firstChild+1);
                return child;
            } else if (endOfList) {
                return null;
            } else {
    ...
    private View findEndView(RecyclerView.LayoutManager layoutManager,
        ...
        if (layoutManager instanceof LinearLayoutManager) {
            ...
            if (layoutManager instanceof GridLayoutManager) {
                offset += (((GridLayoutManager) layoutManager).getSpanCount() - 1)*3;
            }
...
//                child = layoutManager.findViewByPosition(lastChild+1);
                return child;
            } else if (startOfList) {
                return null;
            } else {
