...
class DialogeFragment : DialogFragment() {
    ...
    companion object {
        ...
        fun open(fragmentManager: FragmentManager, className: String, view: View): DialogeFragment {
            view.invalidate()
            val rectf = Rect()
...
//            bundle.putBundle(LISTBUNDLE,bundle)
        ...
        fun open(className: String, view: View, data: Bundle, parentFragment: Fragment): DialogeFragment {
            view.invalidate()
            val rectf = Rect()
            view.getGlobalVisibleRect(rectf)
//            val location = IntArray(2)
...
//            val height = (DimensionUtils.getScreenHeight(view.context!!,true)*0.4f).toInt()
        ...
        // get instance of dialoge with class name , view and bundle
        fun open(className: String, data: Bundle): DialogeFragment {
//            view.invalidate()
//            val rectf = Rect()
//            view.getGlobalVisibleRect(rectf)
//            val location = IntArray(2)
...
//            bundle.putInt(HEIGHVALUE, height)
        ...
        // get instance of dialoge with class name , view and bundle
        fun openBelow(className: String, view: View, width: Int, data: Bundle): DialogeFragment {
            view.invalidate()
            val rectf = Rect()
            view.getGlobalVisibleRect(rectf)
            val location = IntArray(2)
...
//        },animator?.getAnimationTime()?:0)
    ...
    fun showDialog(fragmentManager: FragmentManager) {
        if (getFragmentClassName() == null || fragmentManager.findFragmentByTag(getFragmentClassName()) == null)
...
//    }
    ...
    var animator: AnimatorListenr? = null

}

interface AnimatorListenr {
    fun animate()
